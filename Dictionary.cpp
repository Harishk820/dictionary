...
{
    /*
    objective: gives the  the word entered, and if the entered word is not present in the
    ...
    approach: the input word is send as a parameter to the search function which displays the word  (when found)
    */
...
{
    /*
    objective: to implement a dictionary which gives the  word entered, and if the entered word
    ...
    input parameters:
               word: the word which user wants to find
